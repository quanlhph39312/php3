    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Thùng rác Danh mục sản phẩm</h4>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h5 class="card-title mb-0 flex-grow-1">Danh sách danh mục trong thùng rác</h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('admin.categories.destroy', $item) }}" method="post">
                                            ...
                                            @method('DELETE')
                                            <button type="submit"
                                                onclick="confirmDelete(event,this.closest('form'),'Bạn có chắc chắn muốn khôi phục danh mục này không?')"
