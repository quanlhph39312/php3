    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Danh sách Sản phẩm đã xóa</h4>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h5 class="card-title mb-0 flex-grow-1">Danh sách sản phẩm đã xóa</h5>
                                    ...
                                    <td>
                                        <form action="{{ route('admin.products.destroy', $item) }}" method="POST">
                                            ...
                                            <button
                                                ...
                                                type="submit" class="btn btn-danger">Restore</button>
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
